 ...
 **************************************************************************/
#ifndef WAITPOLICYROBOTCTRL_H
#define WAITPOLICYROBOTCTRL_H

#include "baserobotctrl.h"
#include "broadcast.h"

/**
 * Robot controller based on the waiting times in various
 * situations
 * @author Jens Wawerla
 */
class CWaitPolicyRobotCtrl : public ABaseRobotCtrl
{
  public:
    /**
     * Default constructor
     ...
     */
    CWaitPolicyRobotCtrl( ARobot* robot, float probBroadcast);
    /** Default destructor */
    ~CWaitPolicyRobotCtrl();
    /** Start up policy */
    void startPolicy();
    /**
