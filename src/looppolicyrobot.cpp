...
//-----------------------------------------------------------------------------
CLoopPolicyRobot::CLoopPolicyRobot ( Stg::ModelPosition* modPos )
    : ABaseRobot ( modPos )
{
}
//-----------------------------------------------------------------------------
CLoopPolicyRobot::~CLoopPolicyRobot()
{
}
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::selectWorkTaskPolicy()
{
...
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::startupPolicy()
{
...
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::leaveChargerPolicy()
{
  if ( mCargoLoad == 0 )
    mState = GOTO_SOURCE;
  else
...
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::waitAtSourcePolicy()
{
}
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::waitAtChargerPolicy()
{
}
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::unallocatedPolicy()
{
}
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::pickupCompletedPolicy()
{
}
//-----------------------------------------------------------------------------
void CLoopPolicyRobot::waitingAtPickupPolicy()
{
}
//-----------------------------------------------------------------------------
