 ...
 ***************************************************************************
 * $Log: individualswcostpolicyrobot.h,v $
 ...
 *
 **************************************************************************/
#ifndef INDIVIDUALSWCOSTPOLICYROBOT_H
#define INDIVIDUALSWCOSTPOLICYROBOT_H
 ...
 */
class CIndividualSwCostPolicyRobot : public ABaseRobot
{
  public:
    /**
     * Default constructor
     ...
     */
    CIndividualSwCostPolicyRobot ( Stg::ModelPosition* modPos);
    /** Default destructor */
    ~CIndividualSwCostPolicyRobot();
  ...
  private:
    ...
    /** Vector of experiences */
    std::vector<tExperience> mExperienceVector;
    /** Counts how often we performed the current task since the last switch */
    unsigned short mCountCurrentTask;
};
