...
/**
 * Rapi interface to Nearest Distance obstacle avoidance. The actual
 * algorithm was implemented by J. Minguez and is based on the following
 * publications:
 * J. Minguez, L. Montano
 * Nearness Diagram Navigation (ND): Collision Avoidance in Troublesome
 * Scenarios. In IEEE Transactions on Robotics and Automation, pp 154, 2004.
 *
